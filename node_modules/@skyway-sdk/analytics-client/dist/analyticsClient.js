    ...
    sendSubscriptionStatsReport(report, subscriptionParams) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requestedStatsTypes = this._statsRequest.types
                ...
                return ((isDataChannelStatsReport &&
                ...
                switch (statsRequestType.type) {
                    case 'data-channel':
                        if (subscriptionParams.role === 'sender') {
                            ...
                            const _a = statsRequestType.properties, { bytesReceived } = _a, rest = __rest(_a, ["bytesReceived"]);
                            return {
                            ...
                            const _b = statsRequestType.properties, { bytesSent } = _b, rest = __rest(_b, ["bytesSent"]);
                            return {
                                type: statsRequestType.type,
                                properties: rest,
                            };
                    ...
                    case 'candidate-pair': {
                        if (isDataChannelStatsReport) {
                            ...
                            const _c = statsRequestType.properties, { availableOutgoingBitrate } = _c, rest = __rest(_c, ["availableOutgoingBitrate"]);
                            return {
                                type: statsRequestType.type,
                                properties: rest,
                            };
